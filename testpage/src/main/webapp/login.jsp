                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" name="user" action="tokaworld.do"  /*"login/login_sign.jsp"*/ method="POST">
                                        <div class="form-group">
                                            <input type="id"  name="id" class="form-control form-control-user"
                                        ...
                                        <a onclick="document.forms['user'].submit();" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
                                        <hr>
